 ...
 *
 * @link https://developer.wordpress.org/themes/basics/template-hierarchy/#single-news
 *
 */
get_header();
?>
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
            <article <?php post_class() ?> id="post-<?php the_ID(); ?>">
                ...
                <div class="support-section">
                    ...
                    <div><h4><time datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished"><?php echo get_the_date(); ?></time></h4></div>
